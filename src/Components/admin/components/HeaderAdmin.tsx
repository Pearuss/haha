...
function HeaderAdmin({ titlePage, subTitlePage, searchPlaceholder, showSearch }: any) {
  return (
    <div className="flex items-center mb-4">
      <h2 className="text-textAdmin">{titlePage}</h2>
      <span className="text-sm mt-3 ml-2">{subTitlePage}</span>
      {showSearch && <div className="flex bg-white items-center border-2 ml-auto  rounded-full text-gray-600">
        <input
          type="text"
