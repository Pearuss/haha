...
function TagSection() {
  ...
  return (
    <div
      className="sticky 3xl:top-[-330px] 2xl:top-[-21rem] xl:top-[-21rem] lg:top-[-21rem] 3xl:max-w-[26vw] 3xl:min-w-[22vw] 2xl:max-w-[25vw] 2xl:min-w-[21vw] xl:min-w-[21vw] xl:max-w-[24vw]
      lg:max-w-[24vw] lg:min-w-[20vw] h-full max-h-[140vh] text-gray-900 z-30 md:py-4 sm:py-4 ssm:py-4 md:hidden sm:hidden ssm:hidden ml-auto"
    >
      <Calendar
