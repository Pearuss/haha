...
function login({ submit, errorForm, handleSubmit, control, formState }: any) {
      ...
      <img src="/netflix_logo.png" alt="" />
        ...
        >
          ...
          <p className="flex justify-center mt-12">
            <span className="text-grayText">You don&apos;t have an account?</span>
            <Link href="/auth/register">
              <a className="no-underline ml-1 font-semibold text-white">Sign up</a>
            </Link>
          </p>
          <button className="bg-lightGray text-grayText w-full mx-auto rounded-full font-medium py-3 px-3 mt-12">
            Login with Gate
          </button>
        </form>
      </div>
