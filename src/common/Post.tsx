...
function Post({ post }: any): ReactElement {
  ...
  return (
    <Link href={linkDetail} key={post.id}>
      <div className="relative flex ssm:flex-col w-full ssm:h-auto ssm:max-h-full h-72 max-h-[280px] bg-white rounded-lg px-3 py-5 mb-4 cursor-pointer ssm:border ssm:border-gray-300 ssm:p-4 ssm:pb-20">
